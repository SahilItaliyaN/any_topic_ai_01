    ...
    <section className="flex flex-col h-[70vh]">
      <section className='flex gap-8 max-sm:flex-col'>
        ...
        <div className="user-section">
          ...
          <button className={cn("rounded-lg py-2 cursor-pointer transition-color w-full text-white",callStatus === CallStatus.ACTIVE ? "bg-red-700":"bg-primary",callStatus === CallStatus.CONNECTING && "animate-pulse")} onClick={callStatus === CallStatus.ACTIVE ? handleDisconnect : handleCall }>
