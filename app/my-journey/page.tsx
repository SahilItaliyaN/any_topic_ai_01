      ...
      <section className="flex justify-between gap-4 max-sm:flex-col items-center">
        ...
        <Accordion type="multiple">
          <AccordionItem value="recents">
            <AccordionTrigger className="text-2xl font-bold">Recents Sessions</AccordionTrigger>
            <AccordionContent>
              <CompanionList title="Recents Session" companions={sessionHistory} />
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="compnaions">
